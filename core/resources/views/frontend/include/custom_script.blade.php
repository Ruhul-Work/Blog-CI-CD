...
<script>
    ...
    // });
     ...
     //////---------------->>>>>clickable both route action function <<<<<<<<<<<-----------////////
     function handleBlogClick(event, blogUrl, subscriptionUrl, isPremium, hasAccess) {
        ...
        //show subscription massage when access primium blog 
