    ...
    <main class="main__content_wrapper mt-4">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-5">
                            <div class="product__collection--content">
                                ...
                                <a class="product__collection--content__btn primary__btn btn__style3"
        ...
        <section class="product__section section--padding pt-0 pb-0 my-4">
            <div class="container-fluid">
                ...
                <div class="product__section--inner product__swiper--activation swiper fetch_section"
                        ...
                        <div class="col-lg-3 col-sm-6 col-6 mb-28">
                            <div class="banner__items position__relative">
                                <a class="banner__items--thumbnail " href="{{ $banner->link }}"><img
                                        ...
                                        data-loaded="false" data-src="{{ asset($banner->image) }}"
                                        src="{{ asset('theme/frontend/assets/img/default/banner_sm.png') }}"
                                        alt="banner-img">
                ...
                <div class="row">
                    <div class="col-lg-6 custom-response">
                        <div class="mobile-app-title">
                            ...
                            <a class="app-img"
                                href="https://play.google.com/store/apps/details?id=com.nihazmi.englishmoja&hl=en&gl=US"><img
                                    src="{{ image('theme/frontend/assets/img/banner/g-play.png') }}" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mobile-app-right-image appoint-fift-img">
                            <img data-src="{{ image('theme/frontend/assets/img/banner/app2.png') }}"
                                src="{{ image('theme/frontend/assets/img/default/book.png') }}" alt="mobile-app img"
        ...
        <section class="testimonial__section section--padding pt-0 pb-0">
            <div class="container-fluid">
                ...
                <div class="testimonial__section--inner testimonial__swiper--activation swiper  fetch_section"
                    id="review-section">
                </div>
            </div>
        </section>
                ...
                <div class="shipping__section2--inner shipping__style3--inner row">
                        ...
                        <a href="javascript:void(0)">
                            <div class="shipping__items2 d-flex align-items-center">
                                <div class="shipping__items2--icon ">
                                    <img src="{{ asset('theme/frontend/assets/img/icon/delivery-truck.png') }}"
                                        alt="">
                                </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-6">
                        <a href="javascript:void(0)">
                            <div class="shipping__items2 d-flex align-items-center">
                                <div class="shipping__items2--icon">
                                    <img src="{{ asset('theme/frontend/assets/img/icon/secure-payment.png') }}"
                                        alt="">
                                </div>
                                <div class="shipping__items2--content">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-6">
                        <a href="javascript:void(0)">
                            <div class="shipping__items2 d-flex align-items-center">
                                <div class="shipping__items2--icon">
                                    <img src="{{ asset('theme/frontend/assets/img/icon/availability.png') }}"
                                        alt="">
                                </div>
                                <div class="shipping__items2--content">
            ...
            <div class="floating-offer">
                <div id="campaign-div" class="campaign-div">
                    <div class="position-relative">
                        <a
                            href="{{ route('campaign.single', ['slug' => $featuredCampaign->slug ?? $featuredCampaign->id]) }}">
                            <img src="{{ asset('theme/frontend/assets/img/offer/offer-button.png') }}"
                                alt=" campaign-img">
                        </a>
                        <!--{{ asset($featuredCampaign->icon) }}-->
                        <div class="offer-timer">
                            <p class="text-center text-success fw-bold py-0 mb-0">অফারটি শেষ হবে</p>
                            <div class="deals__countdown--style3 d-flex"
                                data-countdown="{{ $featuredCampaign->end_date }}"></div>
                        </div>
                        <button id="close-btn" class="close-btn">X</button>
                    </div>
                </div>
                <a id="toggle-btn" class="toggle-btn"
                    href="{{ route('campaign.single', ['slug' => $featuredCampaign->slug ?? $featuredCampaign->id]) }}">
                ...
                <div class="box newsletter__popup--box d-flex align-items-center">
                    <div class="newsletter__popup--thumbnail">
                        <img class="newsletter__popup--thumbnail__img display-block"
                            onclick="window.location.href='{{ $popUpBanner->url }}'"
                            src="{{ asset($popUpBanner->image) }}" alt="newsletter-popup-thumb">
                    </div>
                </div>
                ...
                if (requestQueue.length > 0) {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            console.error('Error fetching content for section ' + sectionId + ':',
                                error);
                        },
                        complete: function() {
