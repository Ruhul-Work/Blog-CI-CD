...
@section('meta')
    <title>Home Banner - {{ get_option('title') }}</title>
@endsection
...
<!--   <p class="card-text">-->
<!--    <span v-if="Boolean(item.status)" class="badge badge-success">Active</span>-->
<!--    <span v-if="!Boolean(item.status)" class="badge badge-danger">Inactive</span>-->
<!--</p>-->
...
<script src="{{ asset('theme/admin/assets/vue/axios.min.js') }}" type="text/javascript"></script>
    ...
    @include('backend.modules.homebanner.vue_script')
@endsection
