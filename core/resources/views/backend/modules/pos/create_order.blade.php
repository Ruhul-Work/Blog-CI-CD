...
@section('content')
            ...
            <div class="col-md-4 col-padding">
                <div class="card card-body pos-card-bg gutter-b  border-0 shadow-sm" style="margin-bottom:0px;">
                    <div class="form-group row mb-3">
                        <div class="col-md-6">
                            {{-- <label class="text-black" for="">Publications *</label> --}}
                            <select name="publisher" id="publisher" class="select" onchange="productList()">

                            </select>
                        </div>
                        <div class="col-md-6">
                            {{-- <label class="text-black" for="">Category *</label> --}}
                    ...
                    <div class="form-group row mb-0">
                        <div class="col-md-12">
                            {{-- <label class="text-black">Search Product</label> --}}
                            <fieldset class="form-group mb-0 d-flex barcodeselection">
                                <input type="text" class="form-control product_search" id="product_search"
                                    placeholder="Search Your Product" oninput="productList()">
                            </fieldset>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="pos-products">
                        ...
                        <div class="tabs_container">
                            <div class="tab_content active" data-tab="all">
                                <div class="row" id="productList" style="max-height: 700px; overflow-y: scroll;">
                ...
                <div class="row">
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="cart_shipping" class="form-control"
                                                name="cart_shipping" value="{{get_option('shipping_charge')}}">
                                        </div>
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="packing_charge"
                                                name="packing_charge" value="00">
                                        </div>
                    ...
                    <div class="col-md-12">
                        <aside class="product-order-list shadow">
                            ...
                            <h3 class="offcanvas-title text-center mb-2 text-success" id="offcanvasBottomLabel">Shipping
                                Information</h3>
    ...
    <h5 style="color: #007BFF; font-size: 1.2em; font-weight: bold;">
        Customer Information<i class="fa fa-asterisk"
                                                                style="color:red"></i>
    </h5>
                                    ...
                                    <div class="card-body shippingInfo">
                                        <form action="{{ route('pos.cart.store') }}" method="POST">
                                            ...
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>Sale Date: <i class="fa fa-asterisk"
                                                                style="color:red"></i></label>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="city">City: <i class="fa fa-asterisk"
                                                                style="color:red"></i> <span class="refresh"
                                                                title="Refresh City">
                                                                <i class=" text-danger ri-restart-line"></i>
                                                            </span> </label>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="city">Thana/Upazila: <i class="fa fa-asterisk"
                                                                style="color:red"></i></label>
                                                ...
                                                <div class="col-md-12 ">
                                                     ...
                                                     <div class="btn-div" style="position: fixed;right:-13px;bottom:0;width:100%"> 
    ...
    <script type="text/javascript">
        ...
        <div class="product-list d-flex align-items-center justify-content-between" id="quantity${item.id}">
            <div class="d-flex align-items-center product-info" data-bs-toggle="modal" data-bs-target="#products"   data-item-index="${index}">
                <a href="javascript:void(0);" class="img-bg pos-cart-img">
                ...
                customer.on('change', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#country_id').off('change').val(response.country_id).trigger(
                                "change").on('change', function(event) {
                                event.preventDefault();
                            });


                            setTimeout(function() {
                                $('#city_id').off('change').val(response.city_id)
                            ...
                            setTimeout(function() {
                                $('#upazila_id').val(response.upazila_id).trigger(
                                    "change");
                            }, 1300);
