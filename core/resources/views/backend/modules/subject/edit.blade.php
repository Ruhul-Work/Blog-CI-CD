...
@section('meta')
    <title>Edit Subject - {{ get_option('title') }}</title>
@endsection
...
@section('content')
    ...
    <form action="" id="updateSubject" method="post">
        @csrf
        <div class="card">
                                            ...
                                            <div class="form-group">
                                                <div class="row" id="cover_image">
                                                    @if ($subject->cover_image != null)
                                                        <div class="col-md-6">
                                                            <div class="img-upload-preview">
                                                                <img src="{{ image($subject->cover_image) }}"
                                            ...
                                            <div class="col-lg-3 col-sm-6 col-12">
                                                ...
                                                <div class="form-group">
                                                    <div class="row" id="meta_image">
                                                        @if ($subject->meta_image != null)
                                                            <div class="col-md-6">
                                                                <div class="img-upload-preview">
                                                                    <img src="{{ image($subject->meta_image) }}"
                                                                         alt="icon" style="height: 180px;"
                                                                         class="img-responsive">
                                                                    <button type="button"
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-12">
                                                <div class="add-product list">
                                                    ...
                                                    <textarea rows="8" cols="5" class="form-control h-100"
                                                              ...
                                                              placeholder="Enter text here">{{$subject->meta_description}}</textarea>
