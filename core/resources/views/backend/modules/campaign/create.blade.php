...
@section('meta')
    <title>Create New Campaigns - {{ get_option('title') }}</title>
@endsection
...
@section('content')
    ...
    <form action="" id="createCampaign" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card">
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <div class="mb-3 add-product required">
                                            ...
                                            <input type="text" class="form-control" name="discount"
                                                placeholder="Enter discount here" value="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <div class="mb-3 add-product required">
                                            ...
                                            <select class="form-select select" name="discount_type" width="100%">
                                                @foreach ($discountenums as $enums)
                                                    <option value="{{ $enums->value }}">{{ $enums->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                        ...
                        processResults: function(data) {
                            var results = data.map(function(item) {
                                return {
                                    id: item.id,
                                    text: item
                                        .name // Assuming 'name' is the property representing product name
                                };
                            });
