...
@section('content')
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="{{ route('campaigns.index') }}" class="btn btn-added" data-campaign-id="{{ $campaign->id }}"><i data-feather="plus-circle" class="me-2"></i>Back
                To Campaigns</a>
        </div>
    </div>
