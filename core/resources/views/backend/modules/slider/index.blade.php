...
@section('meta')
    <title>All Sliders - {{ get_option('title') }}</title>
@endsection
...
@section('content')
    <div class="page-header">
        ...
        <ul class="table-top-head">
            ...
            <li>
                <a href="{{ route('sliders.all.delete') }}" class="delete-btn-group" data-bs-toggle="tooltip"
        ...
        <div class="page-btn">
            <a href="{{ route('sliders.create') }}" class="btn btn-added"><i data-feather="plus-circle"
