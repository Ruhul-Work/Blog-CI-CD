...
@section('content')
    <div class="page-header">
        ...
        <ul class="table-top-head">
            ...
            <li>
                <a href="{{ route('authors.all.delete') }}" class="delete-btn-group" data-bs-toggle="tooltip"
                    data-bs-placement="top" title="Delete Selected"><img
                        src="{{ asset('theme/admin/assets/img/icons/delete.svg') }}" alt="img"></a>
            </li>
        </ul>
        <div class="page-btn">
            <a href="{{ route('authors.create') }}" class="btn btn-added"><i data-feather="plus-circle"
