...
@section('meta')
    <title>Create new Publishers - {{ get_option('title') }}</title>
@endsection
...
@section('content')
            ...
            <li>
                <div class="page-btn">
                    <a href="{{ route('publishers.index') }}" class="btn btn-secondary"><i data-feather="arrow-left"
                            class="me-2"></i>Back to Publisher</a>
                </div>
            </li>
            <li>
    ...
    <form action="" id="createPublishers" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card">
        ...
        <div class="col-lg-12">
            <div class="btn-addproduct mb-4">
                <button type="submit" class="btn btn-submit">Create Publisher</button>
            </div>
        </div>
