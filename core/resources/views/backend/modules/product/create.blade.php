...
@section('meta')
    <title>Create new product - {{ get_option('title') }}</title>
@endsection
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="accordion-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            <label class="form-label">Bangla Name <span
                                                    class="star-sign">*</span></label>
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <select class="select" name="product_type" id="product_type">
                                                ...
                                                <option
                                                    value="book" {{ old('product_type') == 'book' ? 'selected' : '' }}>
                                                    Book
                                                </option>
                                                <option
                                                    value="stationary" {{ old('product_type') == 'stationary' ? 'selected' : '' }}>
                                                    Stationary
                                                </option>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <select class="select2AjaxCategory " name="category_id[]"
                                     ...
                                     <div class="col-lg-4 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <input type="text" class="form-control" name="review_url"
                                                   value="{{old('review_url')}}" placeholder="youtube link">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <select name="cover_type" id="cover_type" class="select">
                                                ...
                                                <option
                                                    value="hardcover" {{ old('cover_type') == 'hardcover' ? 'selected' : '' }}>
                                                    Hardcover
                                                </option>
                                                <option
                                                    value="paperback" {{ old('cover_type') == 'paperback' ? 'selected' : '' }}>
                                                    Paperback
                                                </option>
                                                <option
                                                    value="ebook" {{ old('cover_type') == 'ebook' ? 'selected' : '' }}>
                                                    eBook
                                                </option>
                                                <option
                                                    value="audiobook" {{ old('cover_type') == 'audiobook' ? 'selected' : '' }}>
                                                    Audiobook
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <textarea class="form-control  editorBasic " rows="8"
                                            ...
                                            <div class="col-lg-4 col-sm-6 col-12">
                                                <div class="input-blocks add-product">
                                                    ...
                                                    <select class="select" name="discount_type" id="discount_type">
                                                        <option
                                                            value="percentage" {{ old('discount_type') == 'percentage' ? 'selected' : '' }}>
                                                            Percentage
                                                        </option>
                                                        <option
                                                            value="amount" {{ old('discount_type') == 'amount' ? 'selected' : '' }}>
                                                            Amount
                                                        </option>
                                                    </select>
                                            ...
                                            <div class="col-lg-4 col-sm-4 col-12">
                                                <div class="mb-3 add-product">
                                                    ...
                                                    <select class="select" name="show_discount" id="show_discount">
                                                        <option
                                                            value="1" {{ old('show_discount') == 1 ? 'selected' : '' }} >
                                                            Yes
                                                        </option>
                                                        <option
                                                            value="0" {{ old('show_discount') == 0 ? 'selected' : '' }}>
                                                            NO
                                                        </option>
                                                    </select>
                                                </div>
            ...
            $('#category_id').on('change', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.length === 0 || (response.length === 1 && !response[0].id)) {
                            optionsHtml += '<option value="">No subcategories available</option>';
                        } else {
