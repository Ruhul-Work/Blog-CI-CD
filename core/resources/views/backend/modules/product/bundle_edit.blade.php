...
@section('meta')
    <title>Bundle Product Edit- {{ get_option('title') }}</title>
@endsection
@section('content')
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <textarea class="form-control ckEditor" rows="8" name="short_description">{{ $product->short_description }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-8 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            <label class="form-label">Description</label>
                                            <textarea class="form-control ckEditor" rows="8" name="description">{{ $product->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                        ...
                                        @foreach ($product->bundleProducts as $bundleProduct)
                                            <div class="row mt-3">
                                                <input type="hidden" class="form-control bundle_product_id"
                                                    name="bundle_product_id[]"
                                                    value="{{ $bundleProduct->bundle_product_id }}">
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control name" name="name[]"
                                                        value="{{ $bundleProduct->name }}">
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control selling_price"
                                                        name="bundle_current_price[]"
                                                        value="{{ $bundleProduct->current_price }}">
                                                </div>
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control total" name="total[]"
                                                        placeholder="Total" value="{{ $bundleProduct->total }}" readonly>
                                                </div>
                                                <div class="col-md-1 align-center">
                                                    <i class="fas fa-trash delete-bundle-item text-danger fa-lg"
                                                        value="{{ $bundleProduct->bundle_product_id }}"></i>
                                                </div>
                                            </div>

                                            @php
                                                $subtotal += $bundleProduct->total;
                                            @endphp
                                        @endforeach
                                            ...
                                            <div class="col-lg-4 col-sm-6 col-12">
                                                <div class="input-blocks add-product">
                                                    ...
                                                    <select class="select" name="discount_type" id="discount_type">
                                                        <option value=""
                                                            {{ $product->discount_type == null ? 'selected' : '' }}>Choose
                                                        </option>
                    ...
                    <div class="accordion-item">
                        <div class="accordion-header" id="headingFour">
                            <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseFour"
                                ...
                                <div class="addproduct-icon">
                                    <h5><i data-feather="settings" class="add-info"></i><span>Meta Information</span></h5>
                                    <a href="javascript:void(0);"><i data-feather="chevron-down"
                                            class="chevron-down-add"></i></a>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#updateProduct').submit(function(e) {
                ...
                // Make AJAX request
                $.ajax({
                    url: '{{ route('products.bundle.update', $product->id) }}',
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                ...
                selectSimple.on('change', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var bundleProductId = response.id;
                            var bundleProductExists = false;
