                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <textarea name="content" class="editor" id="editor" rows="60" cols="120" placeholder="  Enter Your Blog Content">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            <label class="form-label">Thumbnail Image<span
                                                    class="star-sign">*</span> (1280x960) </label>
                                            ...
                                            <span>Recommended size: 1280x960 pixels</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
