...
@section('meta')
    <title>Edit Category - {{ get_option('title') }}</title>
@endsection
...
@section('content')
    <div class="page-header">
        ...
        <ul class="table-top-head">
            <li>
                <div class="page-btn">
                    <a href="{{route('categories.index')}}" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Back to Categories</a>
                </div>
            </li>
            <li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        ...
                                        <select class="form-select" name="type">
                                            <option value="book" {{ $category->type == 'book' ? 'selected' : '' }}>Book</option>
                                            <option value="stationary" {{ $category->type == 'stationary' ? 'selected' : '' }}>Stationary</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-12">
                                        <label class="form-label">Is_menu</label>
                                        <select class="select" name="is_menu">
                                            <option value="1" {{ $category->is_menu == 1 ? 'selected' : '' }}>Active</option>
                                            <option value="0" {{ $category->is_menu == 0 ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                                    ...
                                                    @if ($category->icon )
                                                        <div class="col-md-6">
                                                            <div class="img-upload-preview">
                                                                <img src="{{ image($category->icon) }}" alt="icon" style="height: 180px;"
                                            ...
                                            <div class="form-group">
                                                <div class="row" id="cover_image">
                                                    @if ($category->cover_image != null)
                                                        <div class="col-md-6">
                                                            <div class="img-upload-preview">
                                                                <img src="{{ image($category->cover_image) }}" alt="icon" style="height: 180px;"
                                                                     class="img-responsive">
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            ...
                                            <textarea class="form-control h-100" rows="8"  name="description" >{{$category->description}}</textarea>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <div class="row" id="meta_image">
                                                       @if ($category->meta_image != null)
                                                            <div class="col-md-6">
                                                                <div class="img-upload-preview">
                                                                    <img src="{{ image($category->meta_image) }}" alt="icon" style="height: 180px;"
                                                                         class="img-responsive">
                                                                    <button type="button"
                                                                            class="btn btn-danger close-btn remove-files"><i
                                                                            class="fa fa-times"></i></button>
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-12">
                                                <div class="add-product list">
                                                    ...
                                                    <textarea rows="8" cols="5" class="form-control h-100" name="meta_description" placeholder="Enter text here">{{$category->meta_description}}</textarea>
