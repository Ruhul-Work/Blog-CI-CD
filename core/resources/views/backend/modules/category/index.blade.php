        ...
        <ul class="table-top-head">
            ...
            <li>
                <a data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" class="delete-btn-group"
                   href="{{route("categories.destroy.all")}}"><i data-feather="trash-2"
            ...
            <div class="table-responsive">
                <table class="table  AjaxDataTable"
                    ...
                    <tr>
                        ...
                        <th class="no-sort" width="10px">Is Menu</th>
...
@section('script')
    <script>
        var AJAX_URL = '{{ route('categories.ajax.index') }}';
        ...
        //is menu stutas function
        $(document).ready(function () {
            $(document).on("click", '.changeIsmenu', function (e) {
                e.preventDefault();
                var categoryId = $(this).data('category-id');

                // Send an AJAX request to update the status of the category
                $.ajax({
                    url: '{{ route('categories.updateIsmenu') }}',
                    type: 'POST',
                    data: {
                        id: categoryId,
                    },
