                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        ...
                                        <select class="select" name="is_menu">
                                            <option value="1" {{ old('is_menu') == 1 ? 'selected' : '' }}>Active</option>
                                            <option value="0" {{ old('is_menu') == 0 ? 'selected' : '' }}>Inactive
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="mb-3 add-product">
                                            <label class="form-label">Cover Image<span
                                                class="star-sign">*</span> (600x600)</label>
                                            ...
                                            <span>Recommended size: 600x400 pixels</span>
