...
@section('content')
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="{{ route('coupons.index') }}" class="btn btn-added"><i data-feather="plus-circle" class="me-2"></i>Back
                To Coupons</a>
        </div>
    </div>
        ...
        <div class="card-body p-2">
            <div class="row">
                <div class="mb-3 text-center">
                    <a href="{{ route('coupons.new.product-add', ['id' => $coupon->id]) }}" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="Add to new Product This Coupon"><button type="button"
                            class="btn btn-success">Add New Products This Coupon</button></a>
                </div>
                ...
                <table id="items" class="table AjaxDataTable" style="width:100%;">
                    <thead>
                        <tr>
                            ...
                            <th class="no-sort" style="width: 15%">Name</th>
                            <th class="no-sort" style="width: 10%">Category</th>
                            <th class="no-sort" style="width: 10%">Author</th>
                            <th class="no-sort" style="width: 10%">Publisher</th>
                            <th class="no-sort" style="width: 10%">Price</th>
                            <th class="no-sort" style="width: 3%">Action</th>
                        </tr>
                    </thead>
...
@section('script')
    <script>
        AJAX_URL = "{{ route('coupons.product.ajax', ['id' => $coupon->id]) }}";
