    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                ...
                <h2><span class="badge bg-primary">{{ $coupon->c_type }}</span></h2>
            </div>
        </div>
        ...
        <div class="page-btn">
            <a href="{{ route('coupons.index') }}" class="btn btn-added" data-coupons-id="{{ $coupon->id }}"><i
            ...
            <div class="row">
                ...
                <div class="mb-3 text-center">
                    <a href="{{ route('coupons.product.store') }}" class="coupon-btn" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="Add To Sections" data-coupon-id="{{ $coupon->id }}"><button
