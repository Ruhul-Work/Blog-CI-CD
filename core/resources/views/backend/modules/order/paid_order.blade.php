...
@section('meta')
    <title>Paid Orders - {{ get_option('title') }}</title>
@endsection
@section('content')
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4> Paid Order Management</h4>
                <h6>List of Paid Orders</h6>
            </div>
        </div>
            ...
            <div class="table-responsive  product-list">
                <table class="table   AjaxDataTable"
                    ...
                    <tr>
                        ...
                        <th class="no-sort" >ShippingDetails</th>
                        <th class="no-sort" >OrderNumber</th>
...
@section('script')
    <script>
        ...
        var AJAX_URL = '{{ route('orders.paid.get') }}';

        function applyFilters() {
            var filters = {
                date_range: $("#datetimes").val()
