...
@section('meta')
    <title>All City- {{ get_option('title') }}</title>
@endsection
    ...
    <div id="app">
                                                        ...
                                                        <div class="col-lg-12 col-sm-12 col-12">
                                                            <div class="mb-3 add-product required">
                                                                ...
                                                                <select class="form-control"
                                                                    ...
                                                                    <option v-for="country in data" :key="country.id"
                                                                        :value="country.id">
                                                                        @{{ country.name }}
                                                                    </option>
                                                                </select>
        ...
        text-align: end;">
                    <a href="javascript:void(0)" class="btn btn-primary me-0" data-bs-toggle="modal"
                        ...
                        <i data-feather="plus-circle"></i>Add City
                    </a>
                </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="table-responsive">
                            ...
                            <div style="position: relative; display: inline-block; margin-top:10px;">
                                <input type="text" v-model="search" placeholder="Search by City" style="width: 100%"
                            ...
                            <table class="table table-hover" style="width:100%; border: 1px solid #ddd;">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-size: 18px; font-weight:600px; width:150px">City</th>
                                        <th style="font-size: 18px; font-weight:600px; width:150px">Bangla Name</th>
                                        <th style="font-size: 18px; font-weight:600px; width:150px">Country</th>
                                        <th style="font-size: 18px; font-weight:600px; width:10px;">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr v-for="(city, index) in paginatedCityData" :key="city.id">
                                        ...
                                        <td>
                                            <div class="action-table-data">
                                                <div class="edit-delete-action">
                                                    <a class="btn btn-info me-2 p-2" @click="showData(city.id)"
                                                        data-bs-toggle="modal" data-bs-target="#statusUpdateModal">
                                                        <i class="fa fa-edit text-white"></i>
                                                    </a>
                                                    {{-- <a class="btn btn-danger p-2" @click="confirmDelete(city.id)">
                            ...
                            <nav class="mt-4">
                                <ul class="pagination">
                                    ...
                                    <li class="page-item" v-for="page in totalCityPages" :key="page"
                                        :class="{ active: page === currentCityPage }">
                                        <a class="page-link" @click.prevent="changeCityPage(page)"
                                            href="#">@{{ page }}</a>
                                    </li>
                                    <li class="page-item" :class="{ disabled: currentCityPage === totalCityPages }">
                                        <a class="page-link" @click.prevent="changeCityPage(currentCityPage + 1)"
...
@section('script')
    ...
    @include('backend.modules.setting.city_script')
