        ...
        <div class="card-body p-2">
            <div class="row">
                <div class="mb-3 text-center">
                    <a href="{{ route('home-category.author-store') }}" class="category-btn" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="Add to home Author" data-parent-id="{{ $hCategory->id }}"><button
                            type="button" class="btn btn-success">Add To Authors</button></a>
                </div>
...
@section('script')
    <script>
        AJAX_URL = "{{ route('home-category.author-ajax') }}";
