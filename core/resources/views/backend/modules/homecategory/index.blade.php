        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h4>Home Page section Management(Ex: Category & Review)</h4>
                    <h6>Home Page section Management </h6>
                </div>
            </div>
            @if ($totalCategories >= 4)
            <div class="page-btn">
                <a href="javascript:void(0)" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#alertmodal">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <div class="alert alert-warning" role="alert">
                            <i class="bi bi-exclamation-triangle-fill"></i> <h3>Only 4 Categories You can Make</h3>
                        </div>
                    </div>
                                                        ...
                                                        <div class="col-lg-12 col-sm-12 col-12">
                                                            <div class="mb-3 add-product required">
                                                                ...
                                                                <select class="form-select form-control"
                                                                    v-model="formData.name" width="100%">
                    ...
                    <div class="card-body">
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <a v-if="item.name === category && !item.has_category_section"
                                    :href="generateUrlAdd(item.id)" class="btn btn-info me-2 mb-2">
                                    <i class="fa fa-plus text-white"></i> Add
                                </a>
                                <a v-if="item.name === category && item.has_category_section"
                                    :href="generateUrlView(item.id)" class="btn btn-info me-2 mb-2">
                                    <i class="fa fa-eye text-white"></i> View
                                </a>

                                <!-- Authors -->
                                <a v-if="item.name === author" :href="homeAuthorUrl(item.id)">
                                    <h5 class="card-title">@{{ item.name }}</h5>
                                </a>
                                <a v-if="item.name === author && !item.has_author_section" :href="homeAuthorUrl(item.id)"
                                    class="btn btn-info me-2 mb-2">
                                    <i class="fa fa-plus text-white"></i> Add
                                </a>
                                <a v-if="item.name === author && item.has_author_section" :href="AuthorView(item.id)"
                                    class="btn btn-info me-2 mb-2">
                                    <i class="fa fa-eye text-white"></i> View
                                </a>
                                ...
                                <a v-if="item.name === publisher && !item.has_publishers_section"
                                    :href="homePublisherUrl(item.id)" class="btn btn-info me-2 mb-2">
                                    <i class="fa fa-plus text-white"></i> Add
                                </a>
                                <a v-if="item.name === publisher && item.has_publishers_section"
                                    :href="generateUrlPublisherView(item.id)" class="btn btn-info me-2 mb-2">
                                    <i class="fa fa-eye text-white"></i> View
                                </a>
                                ...
                                <a v-if="item.name === review && !item.has_review_section" :href="homeReviewUrl(item.id)"
                                    class="btn btn-info me-2 mb-2">
                                    <i class="fa fa-plus text-white"></i> Add
                                </a>

                                <a v-if="item.name === review && item.has_review_section"
                                    :href="generateUrlreviewView(item.id)" class="btn btn-info me-2 mb-2">
                                    <i class="fa fa-eye text-white"></i> View
                                </a>
