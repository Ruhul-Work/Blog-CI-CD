        ...
        <div class="card-body p-2">
            <div class="row">
                <div class="mb-3 text-center">
                    <a href="{{ route('home-category.author-add', ['id' => $hCategory->id]) }}" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="Add To Author Menu"><button type="button"
            ...
            <div class="card table-list-card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table authorAjaxDataTable  table-hover" style="width:100%;" id="items">
                            <thead>
                                <tr>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            var table;
            if ($('.authorAjaxDataTable').length > 0) {
                table = $('.authorAjaxDataTable').DataTable({
                    "bFilter": true,
                    "sDom": 'fBtlpi',
                    "ordering": true,
                    "responsive": true,
                    ...
                    'serverMethod': 'post',
                    'ajax': {
                        url: "{{ route('home-category.author-view-ajax', ['id' => $hCategory->id]) }}"
                    },
                    'aLengthMenu': [
                        [10, 50, 100, 200, 500, -1],
                    ...
                    initComplete: function(settings, json) {
                        ...
                        table.on('row-reorder', function(e, details, edit) {
                            ...
                            var tableId = $('.authorAjaxDataTable').attr('id');

                            $.ajax({
                                url: "{{ route('home-category.author-sorting') }}",
                                type: 'POST',
                                data: {
                                    tableId: tableId,
                                    newOrder: newOrder
