...
@section('meta')
    <title>All Catgory - {{ get_option('title') }}</title>
@endsection
        ...
        <div class="card-body p-2">
            <div class="row">
                <div class="mb-3 text-center">
                    <a href="{{ route('home-category.store') }}" class="category-btn" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="Add to home category" data-parent-id="{{ $hCategory->id }}"><button
                            type="button" class="btn btn-success">Make Home Category</button></a>
                </div>
                ...
                <table id="items" class="table AjaxDataTable" style="width:100%;">
                    <thead>
                        <tr style="width: 3%">
                            ...
                            <th class="no-sort" style="width: 30%">Products</th>
                        </tr>
                    </thead>
...
@section('script')
    <script>
        AJAX_URL = "{{ route('home-category.category-ajax') }}";
