...
@section('meta')
    <title>All Purchases - {{ get_option('title') }}</title>
@endsection
@section('content')
    <div class="page-header">
        ...
        <ul class="table-top-head">
            ...
            <li>
                <a data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" class="delete-btn-group"
                   href="{{route("purchases.destroy.all")}}"><i data-feather="trash-2"
            ...
            <ul  class="table-top-head">
               <li>
                <a data-bs-toggle="tooltip" data-bs-placement="top" title="Update Payment Status" class="paymentStatusChange  bg-info text-white"
                   href="{{ route('purchases.payment.status') }}">Payment Status
                </a>
        ...
        <div class="page-btn d-flex">
            ...
            <a href="{{ route('purchases.create') }}" class="btn btn-added me-2 ">
                <i data-feather="plus-circle" class="me-1"></i>Add New Purchase
            </a>
            ...
            <div class="table-responsive  product-list">
                <table class="table   AjaxDataTable"
                    ...
                    <tr>
                        ...
                        <th class="no-sort" >Purchase Number</th>
...
@section('script')
    <script>
        var AJAX_URL = '{{ route('purchases.ajax.index') }}';
