    ...
    <div class="content pos-design p-0">
        ...
        <div class="row align-items-start pos-wrapper">
            <div class="col-md-12 col-lg-4">
                <div class="  bg-white">
                    <div class="card card-body pos-card-bg gutter-b  border-0" style="margin-bottom:0px;">
            ...
            <div class="col-md-12 col-lg-4 ps-0">
                <aside class="product-order-list">
                            ...
                            <div class="row" style="opacity:0">
                                <div class="col-12 col-sm-6">
                                    <div class="input-block">
                                        ...
                                        <input type="text" class="form-control" id="cart_shipping" name="cart_shipping"  value="0">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="input-block">
                    ...
                    <div class="btn-row d-sm-flex align-items-center justify-content-between ">
                        <a href="javascript:void(0);" class="btn btn-info btn-icon flex-fill d-none" data-bs-toggle="modal" data-bs-target="#payment"><span class="me-1 d-flex align-items-center"><i data-feather="credit-card" class="feather-16"></i></span>Payment</a>
                    </div>
                    <div class="block-section payment-method text-center d-none">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                <label>Purchase Date: <span class="text-danger fs-3">*</span></label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="admin_note" class="form-control" name="admin_note"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <button id="placeOrder" type="submit"
                                                    class="btn btn-danger w-100 mt-3 py-3">Save Purchase</button>
                                        </div>
                                    </div>
