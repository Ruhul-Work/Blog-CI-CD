                    ...
                    <div class="block-section cart-summary-view">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="input-block">
                                        ...
                                        <input type="text" class="form-control" id="cart_shipping"
                                               name="cart_shipping" value="{{$purchase->shipping_charge}}">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="input-block">
                                        ...
                                        <input type="text" class="form-control" id="cart_discount"
                                               name="cart_discount" value="{{$purchase->discount}}">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="input-block">
                                        <label>Packing</label>
                                        <input type="text" class="form-control" id="packing_charge" name="packing_charge" value="{{$purchase->packing_charge}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="order-total  ">
                            <table class="table table-responsive table-borderless">
                                ...
                                <tr>
                                    <td>Paid</td>
                                    <td class="text-end ">{{formatPrice($purchase->transactions->sum('amount'))}}</td>
                                </tr>
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="admin_note" class="form-control" name="admin_note">{{$purchase->admin_note}}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <button id="placeOrder" type="submit"
                                                    class="btn btn-danger w-100 mt-3 py-3">Update Purchase</button>
                                        </div>
                                    </div>
