    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                ...
                <h3><span class="badge bg-primary">Returns</span></h2>
            </div>
        </div>
        ...
        {{-- <div class="page-btn">
            <a href="{{ route('campaigns.index') }}" class="btn btn-added" data-campaign-id=""><i data-feather="plus-circle" class="me-2"></i>Back
                To Campaigns</a>
        </div> --}}
    </div>
            ...
            <div class="row">
                ...
                {{-- <div class="mb-3 text-center">
                    <a href="{{ route('campaigns.all.create') }}" class="campaign-btn" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="Add to Campaign" data-campaign-id="{{ $campaign->id }}"><button type="button" class="btn btn-success">Add
                            to
                            Campaign</button></a>
                </div> --}}
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.message === 'Campaign products added successfully.') {
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Success',
