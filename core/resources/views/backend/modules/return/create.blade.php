...
@section('title')
    <title>Returns-{{ get_option('title') }}</title>
@endsection
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="input-block">
                                        ...
                                        <input type="text" class="form-control" id="cart_discount" value="00"
                                            name="cart_discount">
                                    </div>
                                </div>
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                <label>Customer <span class="text-danger fs-3">*</span></label>
                                                <select class="select" name="customer_id" id="customerid">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                <label>Return Date: <span class="text-danger fs-3">*</span></label>
                                                <input id="return_date" type="date" class="form-control"
                                        ...
                                        <div class="col-md-12">
                                            <button id="placeOrder" type="submit"
                                                class="btn btn-danger w-100 mt-3 py-3">Save Returns</button>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="row ">
                                ...
                                <div class="col-md-4 mb-3 amount">
