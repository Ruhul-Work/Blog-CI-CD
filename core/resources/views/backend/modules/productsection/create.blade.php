    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                ...
                <h2><span class="badge bg-primary">{{ $singleSection->name }}</span></h2>
            </div>
        </div>
        ...
        <div class="page-btn">
            <a href="{{ route('sections.index') }}" class="btn btn-added" data-sections-id="{{ $singleSection->id }}"><i
            ...
            <div class="row">
                ...
                <div class="mb-3 text-center">
                    <a href="{{ route('sections.product.store') }}" class="section-btn" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="Add To Sections" data-section-id="{{ $singleSection->id }}"><button
