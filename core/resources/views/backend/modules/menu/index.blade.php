...
@section('meta')
    <title>All Menus - {{ get_option('title') }}</title>
@endsection
...
@section('content')
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="{{ route('menus.create') }}" class="btn btn-primary me-2"><i data-feather="plus-circle"></i>Add New</a>
        </div>
    </div>
                                            ...
                                            <div class="accordion-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 col-sm-12 col-12 required mb-3">
                                                        ...
                                                        <select class="form-select select" name="section_type"
                                                            width="100%">
...
@section('script')
    ...
    <script>
        ...
        $(document).on("click", '.changeStatus', function(e) {
            e.preventDefault();
            var $label = $(this);
            var authorId = $label.data('menu-id');
