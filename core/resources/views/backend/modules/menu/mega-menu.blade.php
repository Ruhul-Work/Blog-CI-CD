...
@section('content')
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="{{ route('menus.index') }}" class="btn btn-added"><i data-feather="plus-circle" class="me-2"></i>Back To
                Menus</a>
        </div>
    </div>
    <div class="row">
            ...
            <div class="card-body p-2">
                <div class="row text-center m-0 p-0">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <a href="{{ route('menus.megamenu.create') }}" class="submenu-btn" data-bs-toggle="tooltip"
                                data-bs-placement="top" title="Add to Mega" data-menu-id="{{ $menu->id }}"><button
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Add New MegaMenu"><button type="button" class="btn btn-success"
                                    data-bs-toggle="modal" data-bs-target="#subMenuAdd">Create MegaMenu</button></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card table-list-card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table AjaxDataTable  table-hover" style="width:100%;" id="items">
                        <thead>
                            <tr>
                ...
                <div class="page-wrapper-new p-0">
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            <form action="{{ route('menus.store-megamenu') }}" method="post" enctype="multipart/form-data"
                                id="addSubMenu">
                                @csrf
                                <div class="mb-3">
...
@section('script')
    ...
    <script>
        AJAX_URL = "{{ route('menus.megamenu.ajax') }}";
            ...
            $(document).on('click', '.submenu-btn', function(event) {
                ...
                if (selectedIds.length === 0) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'Please select MegaMenu.',
                    });
                } else {
                    Swal.fire({
                        title: 'Are you sure?',
                        text: 'You are about to Add MegaMenu into this Menus',
                        icon: 'warning',
        ...
        $(document).ready(function() {
            $('#addSubMenu').submit(function(e) {
                ...
                // Make AJAX request
                $.ajax({
                    url: '{{ route('menus.store-megamenu') }}',
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
